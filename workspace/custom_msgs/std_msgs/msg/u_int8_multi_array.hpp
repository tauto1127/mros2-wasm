#ifndef _STD_MSGS_MSG_UINT8MULTIARRAY_H
#define _STD_MSGS_MSG_UINT8MULTIARRAY_H
...
namespace std_msgs
{
  namespace msg
  {
    ...
    private:
      std::string type_name = "std_msgs::msg::dds_::UInt8MultiArray";
    };
  };
}
...
{
  template <>
  struct TypeName<std_msgs::msg::UInt8MultiArray *>
  {
