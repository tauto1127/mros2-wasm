#ifndef _SERVICE_MSGS_MSG_ADD_TWO_INT_CLIENT_H
#define _SERVICE_MSGS_MSG_ADD_TWO_INT_CLIENT_H
...
namespace service_msgs
{
  namespace msg
  {
    ...
    private:
      std::string type_name = "service_msgs::msg::dds_::add_two_int_client";
    };
  };
}
...
{
  template <>
  struct TypeName<service_msgs::msg::add_two_int_client *>
  {
    static const char *request_type()
    {
      return "example_interfaces::srv::dds_::AddTwoInts_Request_";
    }
    static const char *response_type()
    {
      return "example_interfaces::srv::dds_::AddTwoInts_Response_";
    }
  };
}
